...
// ... (importaciones y otros controladores)

// Controlador para obtener todos los productos y renderizar la vista
// products.controller.js

// ... (importaciones y otros controladores)

// Controlador para obtener todos los productos y renderizar la vista "home" con los productos
export const getProductsAndRenderView = async (req, res) => {
  try {
    // Obtener los productos de la base de datos utilizando el servicio productService
    const limit = parseInt(req.query.limit) || 10;
    const sort = parseInt(req.query.sort) || 0;
    const page = parseInt(req.query.page) || 1;
    const queryParam = req.query.query || null;
    ...
    // ... (lógica para crear la consulta de búsqueda)
    ...
    // Renderizar la vista "home" y pasar los datos de productos como contexto
